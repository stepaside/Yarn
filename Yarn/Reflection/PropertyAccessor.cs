...
namespace Yarn.Reflection
{
    public static class PropertyAccessor
    {
        ...
        private static GenericSetter CreateSetMethod(PropertyInfo propertyInfo, Type targetType)
        {
            ...
            var setter = new DynamicMethod("Set_" + propertyInfo.Name, typeof(void), new[] { typeof(object), typeof(object) }, typeof(CallContext), true);
        ...
        private static GenericGetter CreateGetMethod(PropertyInfo propertyInfo, Type targetType)
        {
            ...
            var getter = new DynamicMethod("Get_" + propertyInfo.Name, typeof(object), new[] { typeof(object) }, typeof(CallContext), true);
